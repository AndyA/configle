...
Configle.prototype = {
  ...
  resolveConfig: function() {
    if (this.myConfig === undefined) {
      ...
      this.myConfig = SmartString.toStrings(config);
      this.myPathConfig = SmartString.toPathNames(config);
    }
    return this;
  },
  ...
  get: function() {
    ...
    return ConfigData.get(this.myConfig, arguments[0]);
  },

  getPathName: function() {
    this.resolveConfig();
    if (arguments.length === 0) {
      return this.myPathConfig;
    }
    return ConfigData.get(this.myPathConfig, arguments[0]);
  }
